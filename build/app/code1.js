...
{gdjs.evtTools.sound.playSoundOnChannel(runtimeScene, "assets\\dragon-studio-button-press-382713.mp3", 3, false, 100, 0.8);
}
...
if (isConditionTrue_0) {
{gdjs.evtTools.sound.playSoundOnChannel(runtimeScene, "assets\\u_vdwj1c20kz-game-background-sound-342336.mp3", 1, true, 100, 1);
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(14527060);
}
}
if (isConditionTrue_0) {
/* Reuse gdjs.MENUCode.GDRoot2Objects1 */
