...
gdjs.NIVEAU_455Code.GDPlatformLongObjects1_1final = [];

gdjs.NIVEAU_455Code.GDPlatformObjects1_1final = [];

gdjs.NIVEAU_455Code.GDRootObjects1_1final = [];
...
gdjs.NIVEAU_455Code.GDindiceObjects1= [];
gdjs.NIVEAU_455Code.GDindiceObjects2= [];
gdjs.NIVEAU_455Code.GDindiceObjects3= [];
...
{gdjs.evtTools.sound.playSound(runtimeScene, "assets/Trool_Aywen/deconnage.ogg", false, 100, 1);
}
}
...
gdjs.NIVEAU_455Code.asyncCallback15148012 = function (runtimeScene, asyncObjectsList) {
...
gdjs.NIVEAU_455Code.idToCallbackMap.set(15148012, gdjs.NIVEAU_455Code.asyncCallback15148012);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.3), (runtimeScene) => (gdjs.NIVEAU_455Code.asyncCallback15148012(runtimeScene, asyncObjectsList)), 15148012, asyncObjectsList);
}
}
...
};gdjs.NIVEAU_455Code.mapOfGDgdjs_9546NIVEAU_9595455Code_9546GDRootObjects2Objects = Hashtable.newFrom({"Root": gdjs.NIVEAU_455Code.GDRootObjects2});
gdjs.NIVEAU_455Code.mapOfGDgdjs_9546NIVEAU_9595455Code_9546GDPlatformLongObjects2Objects = Hashtable.newFrom({"PlatformLong": gdjs.NIVEAU_455Code.GDPlatformLongObjects2});
gdjs.NIVEAU_455Code.mapOfGDgdjs_9546NIVEAU_9595455Code_9546GDRootObjects2Objects = Hashtable.newFrom({"Root": gdjs.NIVEAU_455Code.GDRootObjects2});
gdjs.NIVEAU_455Code.mapOfGDgdjs_9546NIVEAU_9595455Code_9546GDPlatformObjects2Objects = Hashtable.newFrom({"Platform": gdjs.NIVEAU_455Code.GDPlatformObjects2});
gdjs.NIVEAU_455Code.mapOfGDgdjs_9546NIVEAU_9595455Code_9546GDRootObjects1Objects = Hashtable.newFrom({"Root": gdjs.NIVEAU_455Code.GDRootObjects1});
...
gdjs.NIVEAU_455Code.asyncCallback15156252 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.NIVEAU_455Code.localVariables);
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "Fin_NIVEAUX", false);
}
gdjs.NIVEAU_455Code.localVariables.length = 0;
}
gdjs.NIVEAU_455Code.idToCallbackMap.set(15156252, gdjs.NIVEAU_455Code.asyncCallback15156252);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.NIVEAU_455Code.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.NIVEAU_455Code.asyncCallback15156252(runtimeScene, asyncObjectsList)), 15156252, asyncObjectsList);
}
}
...
};gdjs.NIVEAU_455Code.eventsList3 = function(runtimeScene) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15142884);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15147132);
}
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{gdjs.NIVEAU_455Code.GDPlatformObjects1_1final.length = 0;
gdjs.NIVEAU_455Code.GDPlatformLongObjects1_1final.length = 0;
gdjs.NIVEAU_455Code.GDRootObjects1_1final.length = 0;
let isConditionTrue_1 = false;
isConditionTrue_0 = false;
{
gdjs.copyArray(runtimeScene.getObjects("PlatformLong"), gdjs.NIVEAU_455Code.GDPlatformLongObjects2);
gdjs.copyArray(runtimeScene.getObjects("Root"), gdjs.NIVEAU_455Code.GDRootObjects2);
isConditionTrue_1 = gdjs.evtTools.platform.isOnPlatform(gdjs.NIVEAU_455Code.mapOfGDgdjs_9546NIVEAU_9595455Code_9546GDRootObjects2Objects, "PlatformerObject", gdjs.NIVEAU_455Code.mapOfGDgdjs_9546NIVEAU_9595455Code_9546GDPlatformLongObjects2Objects, false);
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
    for (let j = 0, jLen = gdjs.NIVEAU_455Code.GDPlatformLongObjects2.length; j < jLen ; ++j) {
        if ( gdjs.NIVEAU_455Code.GDPlatformLongObjects1_1final.indexOf(gdjs.NIVEAU_455Code.GDPlatformLongObjects2[j]) === -1 )
            gdjs.NIVEAU_455Code.GDPlatformLongObjects1_1final.push(gdjs.NIVEAU_455Code.GDPlatformLongObjects2[j]);
    }
    for (let j = 0, jLen = gdjs.NIVEAU_455Code.GDRootObjects2.length; j < jLen ; ++j) {
        if ( gdjs.NIVEAU_455Code.GDRootObjects1_1final.indexOf(gdjs.NIVEAU_455Code.GDRootObjects2[j]) === -1 )
            gdjs.NIVEAU_455Code.GDRootObjects1_1final.push(gdjs.NIVEAU_455Code.GDRootObjects2[j]);
    }
}
}
{
gdjs.copyArray(runtimeScene.getObjects("Platform"), gdjs.NIVEAU_455Code.GDPlatformObjects2);
gdjs.copyArray(runtimeScene.getObjects("Root"), gdjs.NIVEAU_455Code.GDRootObjects2);
isConditionTrue_1 = gdjs.evtTools.platform.isOnPlatform(gdjs.NIVEAU_455Code.mapOfGDgdjs_9546NIVEAU_9595455Code_9546GDRootObjects2Objects, "PlatformerObject", gdjs.NIVEAU_455Code.mapOfGDgdjs_9546NIVEAU_9595455Code_9546GDPlatformObjects2Objects, false);
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
    for (let j = 0, jLen = gdjs.NIVEAU_455Code.GDPlatformObjects2.length; j < jLen ; ++j) {
        if ( gdjs.NIVEAU_455Code.GDPlatformObjects1_1final.indexOf(gdjs.NIVEAU_455Code.GDPlatformObjects2[j]) === -1 )
            gdjs.NIVEAU_455Code.GDPlatformObjects1_1final.push(gdjs.NIVEAU_455Code.GDPlatformObjects2[j]);
    }
    for (let j = 0, jLen = gdjs.NIVEAU_455Code.GDRootObjects2.length; j < jLen ; ++j) {
        if ( gdjs.NIVEAU_455Code.GDRootObjects1_1final.indexOf(gdjs.NIVEAU_455Code.GDRootObjects2[j]) === -1 )
            gdjs.NIVEAU_455Code.GDRootObjects1_1final.push(gdjs.NIVEAU_455Code.GDRootObjects2[j]);
...
{
gdjs.copyArray(gdjs.NIVEAU_455Code.GDPlatformObjects1_1final, gdjs.NIVEAU_455Code.GDPlatformObjects1);
gdjs.copyArray(gdjs.NIVEAU_455Code.GDPlatformLongObjects1_1final, gdjs.NIVEAU_455Code.GDPlatformLongObjects1);
gdjs.copyArray(gdjs.NIVEAU_455Code.GDRootObjects1_1final, gdjs.NIVEAU_455Code.GDRootObjects1);
}
}
if (isConditionTrue_0) {
isConditionTrue_0 = false;
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15151804);
}
}
}
if (isConditionTrue_0) {
...
{runtimeScene.getGame().getVariables().getFromIndex(0).setString("NIVEAU-6");
}
...
{ //Subevents
gdjs.NIVEAU_455Code.eventsList2(runtimeScene);} //End of subevents
}
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.NIVEAU_455Code.GDRootObjects1.length;i<l;++i) {
    if ( gdjs.NIVEAU_455Code.GDRootObjects1[i].getBehavior("PlatformerObject").isJumping() ) {
        isConditionTrue_0 = true;
        gdjs.NIVEAU_455Code.GDRootObjects1[k] = gdjs.NIVEAU_455Code.GDRootObjects1[i];
        ++k;
    }
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15158068);
}
}
if (isConditionTrue_0) {
{gdjs.evtTools.sound.stopSoundOnChannel(runtimeScene, 2);
}
{gdjs.evtTools.sound.playSound(runtimeScene, "assets/audio/sfx_jump-high.ogg", false, 50, 1);
}
}
...
gdjs.NIVEAU_455Code.GDindiceObjects1.length = 0;
gdjs.NIVEAU_455Code.GDindiceObjects2.length = 0;
gdjs.NIVEAU_455Code.GDindiceObjects3.length = 0;
gdjs.NIVEAU_455Code.GDRootObjects1.length = 0;
...
gdjs.NIVEAU_455Code.eventsList3(runtimeScene);
gdjs.NIVEAU_455Code.GDAYWENObjects1.length = 0;
gdjs.NIVEAU_455Code.GDAYWENObjects2.length = 0;
gdjs.NIVEAU_455Code.GDAYWENObjects3.length = 0;
gdjs.NIVEAU_455Code.GDLAVAObjects1.length = 0;
